...
namespace Signicat.Information.Organization
{
    ...
    public enum LegalStatus
    {
        ...
        [EnumMember(Value = "insolvent")] Insolvent = 3,

        [EnumMember(Value = "terminating")] Terminating = 4,

        [EnumMember(Value = "terminated")] Terminated = 5
    }
    ...
    public enum OrganizationNameType
    {
        ...
        ///     Trade name
        /// </summary>
        [EnumMember(Value = "tradeName")] TradeName = 1,
