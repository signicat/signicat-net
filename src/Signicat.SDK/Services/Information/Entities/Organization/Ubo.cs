...
namespace Signicat.Information.Organization
{
    ...
    public class UboOwnership
    {
        ...
        /// <summary>
        ///     Voting power in percent. The voting power may reflect the ability to influence the voting outcome or the extent of
        ///     control over the company (the exact formula used to calculate this value may be different depending on the source).
        /// </summary>
    ...
    public enum UboRole
    {
        ...
        [EnumMember(Value = "boardMember")] BoardMember = 1,

        [EnumMember(Value = "shareHolder")] Shareholder = 2,
