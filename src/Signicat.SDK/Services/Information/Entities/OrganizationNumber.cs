namespace Signicat.Information
{
    ...
    public class OrganizationNumber
    {
        ...
        /// <summary>
        ///     Data Universal Numbering System (DUNS number) for the organization.
        ///     https://en.wikipedia.org/wiki/Data_Universal_Numbering_System
        /// </summary>
        public string DunsNumber { get; set; }

        /// <summary>
        ///     Legal Entity Identifier (LEI) - global identifier of legal entities participating in financial transactions.
