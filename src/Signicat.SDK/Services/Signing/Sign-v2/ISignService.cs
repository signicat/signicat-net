...
namespace Signicat.Services.Signing.Sign_v2
{
    ...
    public interface ISignService
    {
        ...
        Document UploadDocument(string fileName, Stream fileData);
        ...
        /// <param name="fileData">File content as byte array</param>
        /// <returns>Document entity</returns>
        Task<Document> UploadDocumentAsync(string fileName, Stream fileData);
        ...
        /// </summary>
        /// <param name="documentCollectionId">Document Collection ID</param>
        void CreateDocumentCollectionPackage(string documentCollectionId);

        /// <summary>
        /// Create a new document collection package.
        /// </summary>
        /// <param name="documentCollectionId">Document Collection ID</param>
        Task CreateDocumentCollectionPackageAsync(string documentCollectionId);
        ...
        PaginatedSigningSessionResponse ListSigningSessions(SigningSessionListOptions options);
        ...
        /// <param name="options">Query parameters</param>
        /// <returns>A paginated list of signing sessions</returns>
        Task<PaginatedSigningSessionResponse> ListSigningSessionsAsync(SigningSessionListOptions options);
        ...
        /// </summary>
        /// <param name="sessionId">Session ID</param>
        void CreateSigningSessionPackage(string sessionId);

        /// <summary>
        /// Create a new signing session package.
        /// </summary>
        /// <param name="sessionId">Session ID</param>
        Task CreateSigningSessionPackageAsync(string sessionId);
